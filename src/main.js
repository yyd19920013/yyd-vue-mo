...
import {XDialog,AlertPlugin,ConfirmPlugin} from 'src/VUX.js'
...
Vue.filter('date',function(value,format){
	...
	return vm.method.dateFormat0(value,format);
});
